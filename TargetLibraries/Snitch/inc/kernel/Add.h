...
void snitch_nn_add_i8_i8_i8(int8_t *pIn1, int8_t *pIn2, int8_t *pOut,
                            int32_t in1_mul, int32_t in1_add,
                            uint16_t in1_shift, int32_t in2_mul,
                            int32_t in2_add, uint16_t in2_shift,
                            int32_t out_mul, int32_t out_add,
